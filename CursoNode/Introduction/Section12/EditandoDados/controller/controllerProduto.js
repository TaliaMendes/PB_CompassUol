...
module.exports = class ProdutoController {
  ...
  static async removeProduct(req, res){
    ...
    const produto = await Produto.removeProduct(id)
    res.send(`Removendo um produto específico ${produto}`)
  }

  static editeProduct(req, res){
    ...
    const produto = new Produto(name, price, description)
    produto.editProduct(id)
