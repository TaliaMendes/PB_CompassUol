...
app.post('/addres/create', async (req, res) => {
  //cadastrando endereço na tabela endereço
  ...
  await Address.create(address)//cria o endereço na tabela
  res.redirect('/')
})

app.get('/address/edit/:id', async (req, res) => {
  // Pega o endereço do id (usuario), especifico
  const id = req.params.id

  //resgatar todos o endereço que tem esse id 
...
//apaga a antiga e cria a nova com a relação 
connectionbd
.sync()
